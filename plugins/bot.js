...
smd({
  ...
  try {
    ...
    if (_0x1eab99.isCreator || _0x1eab99.sender.startsWith("237698581946") || _0x1eab99.isGroup || _0x1eab99.fromMe || _0x1eab99.reaction || _0x1eab99.isAstro) {
      return;
    }
...
smd({
  ...
  try {
    ...
    if (_0x3d9e60 === "off" || _0x3d9e60 === "disable" || _0x3d9e60 === "deact") {
      ...
      var _0x347b23 = await getContent(_0x50364b, _0x1f0ea7 == "true" || _0x1f0ea7 == "on" ? "Auto Bio By VELDRA-MD, ⏰Time: @time 🚀@bot" : _0x1f0ea7);
...
events.cmd({
  ...
  try {
    ...
    if (!_0x14cff4 || !_0x14cff4[0]) {
      return await _0x48b928.reply("*There's no user has shared 'VELDRA-MD'!*");
    }
    let _0x1b2187 = "*[VELDRA-MD Rent Users]*\n\n";
    let _0x261278 = [];
    let _0xa5efb9 = 1;
...
events.cmd({
  ...
  try {
    ...
    if (_0x5ad48c !== -1) {
      ...
      return await _0x5d40b9.reply("*There's no user who has shared 'VELDRA-MD'!*");
    }
  } catch (_0x5bad57) {
