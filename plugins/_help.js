...
❐𝙳𝙰𝚃𝙴 - ${message.date} 
❐𝚃𝙸𝙼𝙴 - ${message.time} 
❐𝙳𝙴𝚅𝙴𝙻𝙾𝙿𝙴𝚁- 𝐋𝐈𝐌𝐔𝐋𝐄 𝐒𝐎𝐋𝐈𝐓𝐀𝐑𝐔𝐒 
❐𝙾𝚆𝙽𝙴𝚁 - ${Config.ownername} 
❐𝙽𝚄𝙼 - ${owner.split(",")[0]} 
❐𝙼𝙴𝙼𝙾 - ${formatp(os.totalmem() - os.freemem())} 
      \n * 𝗩𝗘𝗟𝗗𝗥𝗔 𝗠𝗗 𝗔 𝗦𝗜𝗠𝗣𝗟𝗘 𝗪𝗛𝗔𝗧𝗦𝗔𝗣𝗣 𝗕𝗢𝗧*\n\n ${readmore} 
┏━━❰ 𝐀𝐋𝐋 𝐌𝐄𝐍𝐔 ❱━✪
┃✿︎Lɪꜱᴛ 
┃✿︎Cᴀᴛᴇɢᴏʀʏ 
┃✿︎Hᴇʟᴘ 
...
┃❐ 𝐂𝐨𝐦𝐦𝐚𝐧𝐝𝐬: ${commands.length}
┃❐ 𝐔𝐩𝐭𝐢𝐦𝐞: ${runtime(process.uptime())}
┃❐ 𝐌𝐞𝐦: ${formatp(os.totalmem() - os.freemem())}
╰━━━━━━━━━━━━━━⊷\n`;
