...
smd(
  ...
  async (_0x21be87, _0x17d498) => {
    try {
      if (!_0x17d498) {
        return await _0x21be87.reply(
          "*Give Me A Query To Get Dall-E Reponce?*"
        );
      }
      const _0x27bd9a =
        "https://gurugpt.cyclic.app/dalle?prompt=" +
        encodeURIComponent(_0x17d498);
      try {
      ...
      await _0x21be87.error(
        _0x25b4b9 + "\n\ncommand: dalle",
        _0x25b4b9,
        "*_No responce from Dall-E Ai, Sorry!!_*"
      );
    }
  }
);
  ...
  async (_0x45da98) => {
    try {
      let { data: _0x44f98c } = await axios.get(
        "https://api.github.com/repos/Limule3650/Veldra-Md"
      );
      let _0x1c73f9 = (
        "\nVeldra Md A simple Mutil Device WhatsApp Bot Created and Managed by *" +
        Config.ownername +
        "*. 👑\n\n  *❲❒❳ Stars:* " +
        (_0x44f98c?.stargazers_count || "None (🥲)") +
        " stars\n  *❲❒❳ Forks:* " +
        (_0x44f98c?.forks_count || "1000+") +
        " forks\n  *❲❒❳ Developer:* Limule Solitarus\n  *❲❒❳ Created:* " +
        (_0x44f98c?.created_at || "2024/02") +
        "\n  *❲❒❳ Repo:* _https://github.com/Limule3650/Veldra-Md_\n  *❲❒❳ Scan:* _" +
        scan +
        "_\n" +
        (Config.caption ? "\n\n" + Config.caption : "")
      ).trim();
...
smd(
  {
    ...
    use: "2376985819xx,Your_text_here",
    fromMe: true,
    filename: __filename,
  },
      ...
      if (!_0x14810d) {
        return await _0x165087.reply(
          "*Advertise of your Message*\n*by sending it to provided nmbr range.*\n" +
            prefix +
            "advt 2376985819xx,Your_text_here"
        );
      }
      ...
      if (!_0xd9b857.includes("x")) {
        return _0x165087.send(
          "*You did not add x in number.*\n*Ex: " +
            prefix +
            "advt 2376985819xx,Your_Message_here*  \n " +
            Config.caption
        );
      }
  ...
  async (_0x2acf30) => {
    try {
      if (
        ...
        if (
          _0x2acf30.reply_text.includes("ᴠᴇʟᴅʀᴀ-ᴍᴅ • ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ") &&
          _0x2dfb59[0].includes("ᴠᴇʟᴅʀᴀ-ᴍᴅ • ᴀɴɴᴏɴʏᴍᴏᴜs ᴍsɢ") &&
          ...
          try {
            if (_0x2ecd2a) {
              ...
              if (_0x13a11c.toLowerCase().startsWith("reply")) {
                ...
                let _0x3f6b59 =
                  "*ᴠᴇʟᴅʀᴀ-ᴍᴅ • ʏᴏᴜʀ ᴀɴᴏɴʏ-ᴍsɢ ʀᴇᴘʟʏ*\n\n*_From @" +
