...
smd({
  ...
  try {
    ...
    if (!_0x1c586e) {
      return await _0x1ae8f8.reply("*Provide Repo Url, _.gitclone https://github.com/Limule3650/Veldra-Md_*");
    }
...
smd({
  ...
  try {
    ...
    let _0x4737bb = {
      audio: _0x2ba501,
      fileName: "Veldra-Md tiktok Sound" + _0x19c223 + ".m4a",
      mimetype: "audio/mpeg",
      ptt: true,
...
smd({
  ...
  try {
    ...
    try {
      ...
      let _0x4b47c3 = "./assets/Veldra-Md " + _0x1d542b[1] + ".mp3";
    ...
    let _0x300d1a = {
      ...
      mimetype: "audio/mpeg",
      fileName: "Veldra-Md--" + _0x1d542b[1] + ".mp3",
      caption: Config.caption,
