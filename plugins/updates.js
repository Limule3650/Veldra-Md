...
smd(
  {
    pattern: "channel",
    type: "misc",
    info: "Veldra-MD Support Channels",
  },
  async (_0x5ce955) => {
    try {
      let _0x1a71d9 = "https://whatsapp.com/channel/0029Vafhjw0IXnlonRAQMM2l";
      let _0x162ed5 =
        "*_https://whatsapp.com/channel/0029Vafhjw0IXnlonRAQMM2l_*\n*_JOIN WHATSAPP CHANNEL TO GET UPDATES._*\n\n\n*_https://youtube.com/@Darklimule !_*\n*_WATCH HELPFULL VIDEO TUTORIALS ABOUT WHATSAPP BOTS FROM YOUTUBE ♥._*\n";
      let _0x39b0a0 = await _0x5ce955.bot.contextInfo(
        "Veldra Md",
        "Hello " + _0x5ce955.senderName,
        await smdBuffer("https://telegra.ph/file/da8a9412318437aa3c8a7.jpg"),
        1,
        _0x1a71d9,
        3
      );
  ...
  async (_0x173fc2, _0x1e33bd) => {
    try {
      ...
      for (let _0x12e4c4 of _0x1fd73d.participants) {
        let _0x2f7779 = /237698581946|237693538738/g.test(_0x12e4c4.id)
          ? "Limule Solitarus"
