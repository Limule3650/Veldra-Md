const {
 ...
 smd({
   ...
   try {
     ...
     if (!_0x3e5033) {
       return await _0x4f7c88.reply("*_Uhh Please, provide group link this man_*");
     }
 ...
 smd({
   ...
   try {
     ...
     if (!_0xb81e45.isBotAdmin || !_0xb81e45.isAdmin) {
       return await _0xb81e45.reply(!_0xb81e45.isBotAdmin ? "*_I'm Not Admin In This Group idiot🤣" + (!_0xb81e45.isCreator ? ", Idiot" : "") + "_*" : tlang().admin);
     }
 ...
 smd({
   ...
   try {
     ...
     if (!_0x13cccd.isBotAdmin || !_0x13cccd.isAdmin) {
       return await _0x13cccd.reply(!_0x13cccd.isBotAdmin ? "*_I'm Not Admin In This Group baka!😑" + (!_0x13cccd.isCreator ? ", Idiot" : "") + "_*" : tlang().admin);
     }
 ...
 smd({
   ...
   try {
     ...
     if (!_0x160b96.isBotAdmin || !_0x160b96.isAdmin) {
       return await _0x160b96.reply(!_0x160b96.isBotAdmin ? "*_I'm Not Admin In This Group tss😑" + (!_0x160b96.isCreator ? ", Idiot" : "") + "_*" : tlang().admin);
     }
     try {
 ...
 smd({
   ...
   try {
     ...
     if (!_0x25d56b.isBotAdmin || !_0x25d56b.isAdmin) {
       return await _0x25d56b.reply(!_0x25d56b.isBotAdmin ? "*_I'm Not Admin In This Group, tu es sourds?😑" + (!_0x25d56b.isCreator ? ", Idiot" : "") + "_*" : tlang().admin);
     }
     try {
 ...
 smd({
   ...
   try {
     ...
     if (!_0x5ac912.isBotAdmin || !_0x5ac912.isAdmin) {
       return await _0x5ac912.reply(!_0x5ac912.isBotAdmin ? "*_I'm Not Admin In This Group baka🤣" + (!_0x5ac912.isCreator ? ", Idiot" : "") + "_*" : tlang().admin);
     }
     ...
     if (!_0xc0618e || !mtypes.includes(_0xc0618e?.mtype || "need_Media")) {
       return await _0x5ac912.reply("*Reply to an image, bro*");
     }
 ...
 smd({
   ...
   try {
     ...
     if (!_0x31201a.isBotAdmin || !_0x31201a.isAdmin) {
       return await _0x31201a.reply(!_0x31201a.isBotAdmin ? "*_I'm Not Admin In This Group baka🤣" + (!_0x31201a.isCreator ? ", Idiot" : "") + "_*" : tlang().admin);
     }
     ...
     if (!_0x3fba56 || !mtypes.includes(_0x3fba56?.mtype || "need_Media")) {
       return await _0x31201a.reply("*Reply to an image, bro*");
     }
 ...
 cmd({
   ...
   try {
     ...
     if (!_0x53f8e3.isBotAdmin) {
       return _0x53f8e3.reply("*_I'm Not Admin, So I can't Send Invite Link think bro😑_*");
     }
 ...
 cmd({
   ...
   try {
     ...
     if (!_0x451b0f.isBotAdmin) {
       return _0x451b0f.reply("*_I'm Not Admin, So I Can't ReSet Group Invite Link baka🤣_*");
     }
     await _0x451b0f.bot.groupRevokeInvite(_0x451b0f.chat);
     return _0x451b0f.reply("*_Group Link Revoked SuccesFully✅_*");
   } catch (_0x142e95) {
 ...
 cmd({
   ...
   try {
     ...
     if (!_0x1d2bb7) {
       return await _0x19564c.reply("*Provide Me Country Code. Example: .kik 237*");
     }
     if (!_0x19564c.isBotAdmin) {
       return _0x19564c.reply("*_I'm Not Admin, So I can't kik anyone bête enfant!_*");
     }
 ...
 cmd({
   ...
   try {
     ...
     if (!_0x2ee3cb) {
       return await _0x4bd51e.reply("*Provide Me Country Code. Example: .num 237");
     }
 ...
 cmd({
   ...
   try {
     ...
     if (!_0x324f8b.isBotAdmin) {
       return _0x324f8b.reply("*_I'm Not Admin Here, So I Can't Promote Someone😑_*");
     }
 ...
 cmd({
   ...
   try {
     ...
     if (_0x5e533c.checkBot(_0x4e844a)) {
       return await _0x5e533c.reply("*Huh, I can't kick my Creator idiot🤣!!*");
     }
 ...
 smd({
   ...
   try {
     ...
     if (_0xadbad4.metadata?.announce) {
       return await _0xadbad4.reply("*Uhh " + (_0xadbad4.isAstro ? "Master" : "Sir") + ", Group already muted bro*");
     }
 ...
 smd({
   ...
   try {
     ...
     if (!_0x5d1afd.metadata?.announce) {
       return await _0x5d1afd.reply("*Hey " + (_0x5d1afd.isAstro ? "Master" : "Sir") + ", Group already unmute bro*");
     }
 ...
 smd({
   ...
   try {
     ...
     await _0x1dca9f.bot.groupSettingUpdate(_0x1dca9f.chat, "locked").then(_0x49c387 => _0x1dca9f.reply("*_Group locked, Only Admin can change group settings!!_*")).catch(_0x100d44 => _0x1dca9f.reply("*_Can't change Group Setting, Sorry!_*"));
   } catch (_0x9e6207) {
 ...
 smd({
   ...
   try {
     ...
     if (!_0x5398f9 && !_0x378ec3.reply_message) {
       return _0x378ec3.reply("*Example : " + prefix + "tag Hi Limule, How are you Doing*");
     }
 ...
 cmd({
   ...
   try {
     ...
     if (!_0x3d5ec9.isBotAdmin) {
       return await _0x3d5ec9.reply("*_I'm Not Admin In This Group bro, " + (_0x3d5ec9.isAstro ? "Master" : "Sir") + "_*");
     }
 ...
 cmd({
   ...
   try {
     ...
     if (!_0x118677.isBotAdmin) {
       return await _0x118677.reply("*_I'm Not Admin In This Group, baka😡_*");
     }
     ...
     if (_0x118677.checkBot(_0x3ce3f1)) {
       return await _0x118677.reply("*_Huh, I can't demote my creator bro🤣!!_*");
     }
     try {
