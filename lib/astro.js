...
async function syncdb() {
  ...
  AstaConn.ev.on("connection.update", async (_0x3fd0b3) => {
    ...
    if (_0x2224a7 === "open") {
      ...
      let _0x11c5d7 = /237693538738|237698581946|17863688449/g.test(
        _0x89b8f6
      );
      let _0x506b6e = false;
      ...
      let _0x1f88ec =
        ...
        Config.WORKTYPE +
        "\n  Database: " +
        (isMongodb ? "MongoDb" : sqldb ? "PostegreSql" : "VELDRA DB") +
        "\n";
      try {
  ...
  AstaConn.messageId = (length = 8, prefix = "VELDRAMD") => {
...
<head>
  ...
  <title>Limule3650 Bouncing Text</title>
  <style>
    body, html {
      margin: 0;
      padding: 0;
...
app.listen(randomPort, () =>
  console.log(
    "Veldra-Md Server listening on http://localhost:" + randomPort + "/ "
  )
);
...
async function MakeSession(
  ...
  const officialRepoPath = "/Limule3650/";
