...
const EightD = async _0x78ba44 => {
  const _0x29f51a = "./assets/" + randomBytes(3).toString("hex") + ".mp3";
  _0x78ba44 = Buffer.isBuffer(_0x78ba44) ? save(_0x78ba44, _0x29f51a) : _0x78ba44;
  const _0x25915b = "./assets/" + randomBytes(3).toString("hex") + ".mp3";
...
function save(_0x47b3b7, _0x5a41c3 = "./assets/saveFile.jpg") {
  try {
...
const _parseInput = async (_0x242492, _0x537749 = false, _0xbaa34d = "path") => {
  ...
  const _0x113b13 = "./assets/file_" + randomBytes(3).toString("hex") + "." + (_0x537749 ? _0x537749 : (await fromBuffer(_0x257fef)).ext);
